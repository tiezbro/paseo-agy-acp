...
type NormalizedSqlitePrimaryTerminalDelivery = Omit<SqlitePrimaryTerminalDelivery, "protocol"> & {
  readonly protocol: DurableDeliveryProtocol;
};
...
implements
  ...
  async observeTerminal(
    ...
    let delivery: NormalizedSqlitePrimaryTerminalDelivery;
    try {
...
function normalizeDelivery(value: unknown): NormalizedSqlitePrimaryTerminalDelivery {
