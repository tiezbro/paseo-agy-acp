...
This project is indexed by GitNexus as **paseo-agy-acp** (4438 symbols, 11440 relationships, 300 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
...
| Resource | Use for |
|----------|---------|
| `gitnexus://repo/paseo-agy-acp/context` | Codebase overview, check index freshness |
| `gitnexus://repo/paseo-agy-acp/clusters` | All functional areas |
| `gitnexus://repo/paseo-agy-acp/processes` | All execution flows |
| `gitnexus://repo/paseo-agy-acp/process/{name}` | Step-by-step execution trace |
